...
<head>
    ...
    <link rel="stylesheet" href="<%=basePath %>/pdfjs-1.1.114-dist/web/viewer.css"/>

    <script src="<%=basePath %>/pdfjs-1.1.114-dist/web/compatibility.js"></script>


    <!-- This snippet is used in production (included from viewer.html) -->
    <link rel="resource" type="application/l10n" href="<%=basePath %>/pdfjs-1.1.114-dist/web/locale/locale.properties"/>
    <script src="<%=basePath %>/pdfjs-1.1.114-dist/web/l10n.js"></script>
    <script src="<%=basePath %>/pdfjs-1.1.114-dist/build/pdf.js"></script>


    <script src="<%=basePath %>/pdfjs-1.1.114-dist/web/debugger.js"></script>
    <script src="<%=basePath %>/pdfjs-1.1.114-dist/web/viewer.js"></script>
...
<script>
var DEFAULT_URL = '<%=basePath %>/getPdf?fileName=<%=request.getAttribute("pdf")%>';
PDFJS.imageResourcesPath = '<%=basePath %>/pdfjs-1.1.114-dist/web/images/';
PDFJS.workerSrc = '<%=basePath %>/pdfjs-1.1.114-dist/build/pdf.worker.js';
PDFJS.cMapUrl = '<%=basePath %>/pdfjs-1.1.114-dist/web/cmaps/';
PDFJS.viewerWrapper = document.getElementById("viewerWrapper");
</script>
</html>
